...
class ProfileRepositoryImp(
    ...
    override fun isUserBeingFollowed(
        currentUId: String,
        targetUId: String,
        result: (Boolean) -> Unit
    ) {
    ...
    override fun getProfileCountData(
        uid: String,
        postType: String,
    ...
    override fun getUserDataList(
        uid: String,
        collection: String,
        result: (UiState<List<UserData>>) -> Unit
    ) {
