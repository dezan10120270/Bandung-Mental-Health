...
import com.example.bandungmentalhealthv10.databinding.DialogBottomDiaryOptionsBinding
...
@AndroidEntryPoint
class DiaryOptionsBottomSheetFragment(private val deleteDiaryStatusListener: DeleteDiaryStatusListener) :
