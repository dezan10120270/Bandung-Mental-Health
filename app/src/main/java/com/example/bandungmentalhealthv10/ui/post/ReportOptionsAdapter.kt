...
import com.example.bandungmentalhealthv10.databinding.ItemReportOptionsBinding
...
class ReportOptionsAdapter(
    ...
    inner class ReportOptionsViewHolder(val binding: ItemReportOptionsBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ReportOptionsViewHolder {
        val itemView =
            ItemReportOptionsBinding.inflate(LayoutInflater.from(parent.context), parent, false)
